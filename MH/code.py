...
if choice == "메인페이지":
    ...
    with tab3:
        ...
        * 팀 Notion 페이지 링크
        > [![Notion](https://img.shields.io/badge/Notion-Sports%20TooToo-white)](https://www.notion.so/SPORT-TOO-TOO-ab7919e6c97a47f9b1ca661837550d05)
    ...
    st.write()
    '''
    ##### ▪️가상의 선수🤾의 추가하여 승률을 예측해 보세요
    ###### ▪️아래의 슬라이더를 움직여 스탯을 조정할 수 있습니다
