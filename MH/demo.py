...
# ----------------------------------------------------------------------------------------------------------
# 1번
quiz1_password = st.text_input("1번 문제 오픈을 위한 비밀번호를 입력해주세요!",  key="quiz1_password", type='password')
...
if quiz2_password == password2:
    ...
    if st.button("힌트 보기", key = "check_hint_button2"):
        ...
        st.write("만든 사람은 공지방에서 이벤트 알림이 역할을 하고 있어!")
...
# ----------------------------------------------------------------------------------------------------------
# 4번
quiz4_password = st.text_input("4번 문제 오픈을 위한 비밀번호를 입력해주세요!")