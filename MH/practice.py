...
with tab0:
    ...
    **⬆️위의 탭에 있는 메뉴를 클릭해 선택하신 항목을 볼 수 있습니다!⬆️**
    ...
    | :---: | :---: | :---: | :---: |
    | 이규린 | 팀장<br>전처리<br>ppt발표<br> | 그래프 시각화 | 그래프 시각화 |
    | 김명현 | 년도, 성별(나이포함)에 대한 구매 품목 상위 5개 변화추이 그래프 | Streamlit 작성 | 그래프 시각화 |
    | 배진우 | countplot으로 평일/휴일의 상품판매량 대한 그래프  | 그래프 시각화 | 그래프 시각화 |
    ---
    ### Chart & Data List 📝
    > * 막대 차트
    >> * 차트1
